            ...
            <Card.Body>
              <Form>
                <Form.Group className="mb-3">
                  <Form.Check inline defaultChecked type="radio" label="Production Order" name="orderType" id="supportedRadio21" />
                  <Form.Check inline type="radio" label="Random Palletizing" name="orderType" id="supportedRadio22" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="productionOrder">
                ...
                <Row>
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="warehouseFrom">
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="warehouseTo">
